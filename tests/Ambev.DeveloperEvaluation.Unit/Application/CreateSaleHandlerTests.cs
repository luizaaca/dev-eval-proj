...
public class CreateSaleHandlerTests
{
    ...
    public async Task Handle_RepositoryFails_ReturnsFailResponse()
    {
        ...
        response.Message.Should().Be("Falha ao criar a venda.");
    }
    ...
    public async Task Handle_RepositoryThrowsException_ReturnsFailResponse()
    {
        ...
        _mapper.Map<Sale>(command).Returns(sale);
        _saleRepository.CreateAsync(sale, Arg.Any<CancellationToken>()).Throws(new Exception("Erro inesperado"));
        ...
        // Assert
        response.Success.Should().BeFalse();
        response.Message.Should().Contain("Erro");
    }
